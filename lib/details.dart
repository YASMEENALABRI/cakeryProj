            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Email: ${user['email']} - Address: ${user['address'].toString()}'),
                  trailing: Row(
                    ...
                    children: <Widget>[
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateUserScreen(user)));
                        },
                      ),
                      IconButton(
